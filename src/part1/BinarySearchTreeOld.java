...
public class BinarySearchTreeOld<E> extends AbstractSet<E> 
{
     ...
     *
     */
    public BinarySearchTreeOld(BinarySearchTreeOld<? extends E> otherTree)
    {
	...
	public boolean equals (Object obj)
    {
        if (!(obj instanceof BinarySearchTree))
            return false;
        return equals (root, ((BinarySearchTreeOld<? extends E>)obj).root);
    ...
    protected Entry<E> getEntry (Object obj) 
    {
        ...
        while (e != null) 
        {
            comp = ((Comparable<E>)obj).compareTo (e.element);
            if (comp == 0)
                return e;
            else if (comp < 0)
                e = e.left;
